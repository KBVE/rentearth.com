    ...
    >
      <div class="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2">
        ...
        <div>
            <p class="my-8">
              <span class="font-medium dark:text-gray-50">
                <span class="gradient-text">Profile</span> We need to create you a legal profile!</span
              >
            </p>
            <form
              action="#"
            ...
            >
              ...
              <div>
                <label for="email" class="text-sm sr-only">Public Username</label>
                <input
                  id="username"
                  type="text"
