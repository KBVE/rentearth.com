...
<WidgetWrapper background="https://kbve.com/assets/img/curved-images/wave.jpg">
  <selection>
    <div class="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-offset">
      ...
      <div>
        <img src={finalLogo} alt="" class="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500">
        <h2 class="mb-1 text-xl font-semibold">Nam cu platonem posidonium sanctus debitis te</h2>
        <p class="text-sm dark:text-gray-400">Eu qualisque aliquando mel, id lorem detraxit nec, ad elit minimum pri. Illum ipsum detracto ne cum. Mundi nemore te ius, vim ad illud atqui apeirian...</p>
      </div>
      <div class="flex flex-wrap justify-between">
        <div class="space-x-2">
          <button aria-label="Share this post" type="button" class="p-2 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 fill-current dark:text-orange-400">
        ...
        <div class="flex space-x-2 text-sm dark:text-gray-400">
          <button type="button" class="flex items-center p-1 space-x-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of comments" class="w-4 h-4 fill-current dark:text-orange-400">
          ...
          <button type="button" class="flex items-center p-1 space-x-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of likes" class="w-4 h-4 fill-current dark:text-orange-400">
        ...
        {/if}
          ...
          <div>
            ...
            <input
              ...
              placeholder="64e116efe1e76c3ee0a8"
              required
              bind:value={task} />
          </div>
          <div>
          ...
          <button
            ...
            disabled={loading}
            ><span>{loading ? 'Loading' : 'Execute'}</span></button>
