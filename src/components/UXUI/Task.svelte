    ...
    <div class="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-offset">
      <div class="flex space-x-4">
        ...
        <div class="flex flex-col space-y-1">
          <a rel="noopener noreferrer" href="#/" class="text-sm font-semibold">Atlas</a>
          <span class="text-xs">Some hours ago</span>
        </div>
      </div>
      <div>
        {#if finalLogo}
        <img src={finalLogo} alt="" class="object-cover w-full mb-4 h-60 sm:h-96 ">
        {:else}
      ...
      <div class="flex flex-wrap justify-between">
        <div class="space-x-2">
          <button aria-label="Share this post" type="button" class="p-2 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 fill-current text-orange-400">
        ...
        <div class="flex space-x-2 text-sm">
          <button type="button" class="flex items-center p-1 space-x-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of comments" class="w-4 h-4 fill-current text-orange-400">
          ...
          <button type="button" class="flex items-center p-1 space-x-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of likes" class="w-4 h-4 fill-current text-orange-400">
