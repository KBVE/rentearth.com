...
//  const rock3 = useLoader(GLTFLoader, process.env.PUBLIC_URL + "/models/floating_rock_3.glb");
  ...
  const rock1 = useLoader(GLTFLoader,  "/r3f/models/floating_rock_1.glb");
  const rock2 = useLoader(GLTFLoader, "/r3f/models/floating_rock_2.glb");
  const rock3 = useLoader(GLTFLoader, "/r3f/models/floating_rock_3.glb");
