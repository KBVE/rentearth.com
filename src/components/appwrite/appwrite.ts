...
export const OAuth2 = async ({provider, valid = 'https://rentearth.com/account/', failure = 'https://rentearth.com/account/login/?failure'} : {provider: string, valid?: string, failure?: string}) => {
	try {
